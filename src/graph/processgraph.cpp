...
{
    if(!m_nodes.at(outputPoint.nodeId)->isPointAvailable(outputPoint.portNumber, PointDirection::Output) ||
            !m_nodes.at(outputPoint.nodeId)->isPointAvailable(outputPoint.portNumber, PointDirection::Output) )
    {
        return false;
    }
...
{
    if(!m_nodes.at(newInit.nodeId)->isPointAvailable(newInit.portNumber,
